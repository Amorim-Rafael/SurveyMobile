package md5115b5e3af3045b2cfe8bbcf468c1364e;


public class EditNewRespostaLayout
...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("SurveyMobile.Droid.UserInterfaceLayer.Layout.EditNewRespostaLayout, SurveyMobile.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", EditNewRespostaLayout.class, __md_methods);
	}


	public EditNewRespostaLayout (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == EditNewRespostaLayout.class)
			mono.android.TypeManager.Activate ("SurveyMobile.Droid.UserInterfaceLayer.Layout.EditNewRespostaLayout, SurveyMobile.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public EditNewRespostaLayout (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == EditNewRespostaLayout.class)
	...
	public EditNewRespostaLayout (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == EditNewRespostaLayout.class)
	...
	public EditNewRespostaLayout (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == EditNewRespostaLayout.class)
